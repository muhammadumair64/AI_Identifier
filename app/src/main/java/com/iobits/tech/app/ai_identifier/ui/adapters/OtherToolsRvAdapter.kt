...
import com.iobits.tech.app.ai_identifier.databinding.ItemOtherRvBinding
...
class OtherToolsRvAdapter(
    private val context: Context,
    private val arrayList: ArrayList<MainRvDataClass>,
    private val onClickItem: (String)-> Unit,
    private val onPremium: (String)-> Unit
) : RecyclerView.Adapter<OtherToolsRvAdapter.ModRvViewHolder>() {

    class ModRvViewHolder(val binding: ItemOtherRvBinding) : RecyclerView.ViewHolder(
        binding.root
    )

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ModRvViewHolder {
        val binding = ItemOtherRvBinding.inflate(
    ...
    override fun onBindViewHolder(holder: ModRvViewHolder, position: Int) {
        ...
        holder.binding.img.setImageDrawable(ContextCompat.getDrawable(context, item.imgDrawableId))
