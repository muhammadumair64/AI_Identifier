...
) : RecyclerView.Adapter<AnimalsRvAdapter.ModRvViewHolder>() {

    class ModRvViewHolder(val binding: ItemAnimalsRvBinding) : RecyclerView.ViewHolder(
        binding.root
    )

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ModRvViewHolder {
        val binding = ItemAnimalsRvBinding.inflate(
